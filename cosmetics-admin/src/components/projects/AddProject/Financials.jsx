      ...
      <div className="space-y-8">
        ...
        <div>
          <h4 className="mb-8 text-xl font-bold">
            {projectTypeName === PROJECT_TYPE.INVESTMENT
              ? "Investment Details"
              : "Asset Value"}
          </h4>
          ...
          <div className="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-3">
            ...
            <div className="mb-4">
              ...
              <input
                type="text"
                className="border-gray-300 w-full rounded-md border p-2"
                placeholder="Total Slot(s) Count"
                name="perShareValue"
            ...
            <div className="mb-4">
              ...
              <input
                type="text"
                className="border-gray-300 w-full rounded-md border p-2"
                placeholder="Minimum Investment Slot(s) Value"
        ...
        <div>
          <h4 className="mb-8 text-xl font-bold">
            {projectTypeName === PROJECT_TYPE.MURABAHA ? "Profit" : "Return"}{" "}
          </h4>
          ...
          <div className="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-3">
            ...
            <div className="mb-4">
              <label className="text-gray-700 mb-2 block font-semibold">
                Annual{" "}
                {projectTypeName === PROJECT_TYPE.MURABAHA
                  ? "Profit"
                  : "Return"}{" "}
                Value (%):
              </label>
