...
const CompanyUpdate = ({ companyBankAccount }) => {
  ...
  const handleUpdateBankAccount = async (e) => {
    ...
    try {
      ...
      await axios.patch(
        `${getBaseUrl()}/company-bank/${companyBankAccount?._id}`,
        bankAccountData,
        {
          headers,
        }
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div>
            ...
            <input
              ...
              defaultValue={companyBankAccount?.bankName}
          ...
          <div>
            ...
            <input
              ...
              defaultValue={companyBankAccount?.accountHolderName}
              className="w-full h-12 border border-gray-300 rounded-lg focus:border-lime-300 focus:outline-none px-2 transition duration-300"
            />
          </div>
          <div>
            ...
            <input
              ...
              defaultValue={companyBankAccount?.accountNumber}
              className="w-full h-12 border border-gray-300 rounded-lg focus:border-lime-300 focus:outline-none px-2 transition duration-300"
            />
          </div>
          <div>
            ...
            <input
              ...
              defaultValue={companyBankAccount?.accountType}
              className="w-full h-12 border border-gray-300 rounded-lg focus:border-lime-300 focus:outline-none px-2 transition duration-300"
            />
          </div>
          <div>
            ...
            <input
              ...
              defaultValue={companyBankAccount?.branchName}
              className="w-full h-12 border border-gray-300 rounded-lg focus:border-lime-300 focus:outline-none px-2 transition duration-300"
            />
          </div>
          <div>
            ...
            <input
              ...
              defaultValue={companyBankAccount?.routingNumber}
              className="w-full h-12 border border-gray-300 rounded-lg focus:border-lime-300 focus:outline-none px-2 transition duration-300"
            />
          </div>
