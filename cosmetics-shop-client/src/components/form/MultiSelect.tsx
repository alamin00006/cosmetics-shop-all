              ...
              <div className="flex flex-auto flex-wrap gap-2  ">
                {selectedValuesText.length > 0 ? (
                  selectedValuesText.map((text, index) => (
                    <div
                      key={index}
                      className="capitalize group flex items-center justify-center rounded-full border-[0.7px] border-transparent bg-gray-100 py-1 pr-2 pl-2.5 text-sm text-gray-800 hover:border-gray-200 dark:bg-gray-800 dark:text-white/90 dark:hover:border-gray-800"
                    >
                      <span className="max-w-full flex-initial capitalize">{text}</span>
                  ...
                  <input
                    ...
                    className="h-full w-full appearance-none border-0 bg-transparent p-1 pr-2 text-sm outline-hidden placeholder:text-gray-800 focus:border-0 focus:ring-0 focus:outline-hidden dark:placeholder:text-white/90 capitalize"
                    readOnly
                    value="Select option"
                  />
                )}
                ...
                {options.map((option, index) => (
                  <div key={index}>
                    ...
                    >
                      ...
                      >
                        <div className="mx-2 leading-6 text-gray-800 dark:text-white/90 capitalize">
                          {option.text}
                        </div>
                      </div>
                    </div>
