...
const trendItems: TrendItem[] = [
  {
    ...
    imageUrl:
      "https://hokmakeup.com/cdn/shop/videos/c/vp/90514734fb504836a6e14886f6092383/90514734fb504836a6e14886f6092383.SD-480p-0.9Mbps-45548618.mp4?v=0",
  ...
  },
  {
    ...
    imageUrl:
      "https://hokmakeup.com/cdn/shop/files/Artboard_1_c973caca-d705-4b2e-9cad-37559f7c9a78.jpg?v=1744098408",
  ...
  },
  {
    ...
    imageUrl:
      "https://hokmakeup.com/cdn/shop/files/Artboard_2_e0c84a0f-7231-4901-8b0c-c38a5412b2ce.jpg?v=1744098408",
    ...
    <section className="py-6 bg-white">
      <SliderContainer className={" "}>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-2">
          ...
          <Link
            href={trendItems[0].link}
            className="relative block h-90 sm:h-96 md:h-[41rem] md:col-span-2"
          >
          ...
          <div className="flex flex-col gap-2 md:col-span-1">
            {/* Top Right Image */}
            <Link
              href={trendItems[1].link}
              className="relative block h-40 sm:h-48 md:h-80"
            >
              <div
                className="w-full h-full bg-cover bg-center"
