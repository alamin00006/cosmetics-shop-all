...
const SquareBanner: React.FC = () => {
  ...
  const desktopImageSrc =
    "https://hokmakeup.com/cdn/shop/files/Foundation_Finder_Banner_1920x463_84ec4b75-56b0-4587-b569-8426df479283.jpg?v=1741861460&width=1920";
  const desktopSrcSet = [
  ...
  const mobileImageSrc =
    "https://hokmakeup.com/cdn/shop/files/Foundation_Finder_Banner_780x600_b209b435-1752-4842-9622-da3cfa965a64.jpg?v=1741861463&width=550";
