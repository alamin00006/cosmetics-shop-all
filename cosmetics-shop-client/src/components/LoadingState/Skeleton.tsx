const Skeleton = () => {
  return (
    <div
      role="status"
      className="max-w-[500px]  p-4 border border-gray-200 rounded shadow animate-pulse"
    >
      ...
      {/* Text skeleton please don't remove this line*/}
      ...
      <div className="h-3 bg-gray-200 rounded-full dark:bg-gray-700 mb-2.5"></div>
      <div className="h-3 bg-gray-200 rounded-full dark:bg-gray-700 mb-2.5"></div>
      {/* Status indicators skeleton please don't remove this line*/}
      ...
      {/* Button skeleton */}
      <div className="mt-4">
        <div className="h-10 bg-gray-200 rounded-full dark:bg-gray-700 w-90"></div>
      </div>
    </div>
  );
};
